...
useEffect(() => {
  ...
  return (
    <div className="writers flex  justify-center items-center flex-col  gap-2 mt-6">
      <h1 className='text-4xl sm:text-5xl font-extrabold text-gray-900 text-center mb-4 '>Top <span className='text-blue-600'>Writers</span></h1>

      <div className="container flex flex-wrap justify-center gap-1 sm:gap-2 3xl:gap-4 mt-42 ">

        {writers.slice(0,Items).map((writer, index) => (
...
export const WritersCard = ({ writer }) => {
  return (
    <motion.div
      ...
      className="writer flex flex-col items-center w-full sm:w-[265px] md:w-[300px]
